...
BOT_TOKEN = environ.get('BOT_TOKEN', '5610935227:AAEk-6tMyoAHt2GEtTD7K3Q0__pREp2CKYg')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5447134162 6237272791').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001830830978').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('AUTH_CHANNEL','-1001627475866')
...
# url shortner
SHORT_URL = environ.get("SHORT_URL","flashlink.in")
SHORT_API = environ.get("SHORT_API","8adb04a66eba68171bd5a17db3456088aa4f0647")

# Others
IMDB_DELET_TIME = int(environ.get('IMDB_DELET_TIME', "300"))
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001780905599'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'f9devs')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "True")), True)
PM_IMDB = environ.get('PM_IMDB', "True")
IMDB = is_enabled((environ.get('IMDB', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "True")), True)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "📂 𝗙𝗶𝗹𝗲 𝗡𝗮𝗺𝗲: {file_name}\n\n\n🎉 𝙅𝙊𝙄𝙉 𝙉𝙊𝙒: <a href=https://t.me/MOVIEBEEBASIC>🐝𝙈𝙊𝙑𝙄𝙀𝘽𝙀𝙀 </a>")
